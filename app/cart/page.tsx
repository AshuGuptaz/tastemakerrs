          ...
          <div className="mt-10 grid gap-8 lg:grid-cols-[1fr_380px]">
            <div className="space-y-4">
              {items.map((it, i) => (
                ...
                >
                  <div className="relative grid h-24 w-24 place-items-center overflow-hidden rounded-2xl bg-surface text-5xl">
                  ...
                  <div className="min-w-0 flex-1">
                    <h3 className="truncate text-base font-semibold text-ink">{it.name}</h3>
                  ...
                  <button onClick={() => remove(it.id, it.variant)} className="grid h-10 w-10 place-items-center rounded-pill text-ink-mut hover:bg-rose-500 hover:text-white focus-ring" aria-label="Remove">
